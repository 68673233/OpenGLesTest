...
public class GrayFilter {
    ...
    private String currFragment=Tools.FragmentShader_Grad;
...
//        float[] grayFilterColorData = {0.299f, 0.587f, 0.114f};
    float[] grayFilterColorData = {0.299f, 0.587f, 0.114f};
    public void setGrayFilterColorData(float[] grayFilterColorData){this.grayFilterColorData=grayFilterColorData;}
