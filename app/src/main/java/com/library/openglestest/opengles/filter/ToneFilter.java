...
public class ToneFilter {
    ...
    private String currFragment=Tools.FragmentShader_Tone;
    ...
    public ToneFilter(Context context){
    ...
    //冷色调
    float[] toneFilterColorData = {0, 0f, 1f};
    public void setToneFilterColorData(float[] toneFilterColorData){this.toneFilterColorData=toneFilterColorData;}

    public void drawSelf(){
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, this.textureId);
        GLES20.glUniform3fv(toneChangeColor, 1, toneFilterColorData, 0);
        vertex.position(0);
// load the position
